...
//    }
    ...
    {
        public ComputeQueue(Device device, QueueFamily queueFamily) {
            super(device, queueFamily.getFamilyIndex(), queueFamily.getFirstAvailableQueue().getIndex());
        }
        public ComputeQueue(Device device, int fam,int queue) {
            super(device, fam, queue);
        }
